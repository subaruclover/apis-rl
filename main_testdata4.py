#!/usr/bin/env python
"""
DQN testing, single run, house E004
...
# Testing function
def test(RL):
    print("House E004, testing start")
    total_steps = 0
    steps = []
    episodes = []
    reward_list = []
    ...
    for i_episode in range(EPI):
        ...
        while day < N_DAY:
            ...
            print("House E004, Scenario file updated with act_req {}, {} and act_acc {}".format(
...
saver = tf.train.import_meta_graph('model/E004/E004_model_prio.meta')
with tf.Session() as sess:
    saver.restore(sess, 'model/E004/E004_model_prio')
    ...
    with tf.variable_scope('DQN_with_prioritized_replay'):
        RL_prio_test = DQNPrioritizedReplay(
            ...
            e_greedy_increment=0.004, sess=None, prioritized=True, test=True, output_graph=True,
        )  # n_features: 6 states
...
with open("saved/prio_memo_e004_Feb_test.data", "wb") as fp:
    pickle.dump(prio_memory, fp)
# save reward to json file
with open("saved/prio_reward_e004_Feb_test.data", "wb") as fp:
